\begin{titlepage}
    ...
    \begin{textblock}{9.4}(0,5)
        \Huge{\fontfamily{ptm}\selectfont\bfseries{Aroma Development and Volatile Composition in Mango (\textit{Mangifera indica L.}) }}
    \end{textblock}
    
    \begin{textblock}{9.4}(0,7.5)
        \LARGE{\fontfamily{ptm}\selectfont\bfseries{A Theoretical Report on the Biochemical Pathways, Ripening Physiology, and Quality Determinants in mango.}}
    \end{textblock}
